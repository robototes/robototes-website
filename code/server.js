...
app.set("debug", configs.DEBUG || process.env.DEBUG || process.env.NODE_ENV == null || process.env.NODE_ENV === "development" || false) // The current environment (development|production)
